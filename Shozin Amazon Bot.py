...
urls = ["https://www.amazon.in/gp/bestsellers/automotive/5257472031/ref=zg_bs_pg_1?ie=UTF8&pg=1",
...
"https://www.amazon.in/gp/bestsellers/automotive/?ie=UTF8&ref_=sv_automotivesubnav_1",
            ...
            for i in range(1, 9):
                ...
                for product in products:
                    ...
                    try:
                        ...
                        # print (f"\n{product_url}\n")
                        asin = re.search(r'/dp/([A-Z0-9]{10})/', product_url).group(1)
                    except:
                        pass
                    ...
                    video_urls = soup.find_all('div', {'id': 'ajaxBlockComponents_feature_div'})
                    ctr=1
                    ...
                    for video in video_urls:
                        try:
                            ...
                            for x in new['videos']:
                                ...
                                products_title = soup.find(id="productTitle").text.strip()
                                            
                                yt_title_new = products_title.title()[:76]
                                            
                                yt_replace = re.sub(r'[^\w\s]', '', yt_title_new)

                                yt_title = f'latest Car Accessories: {yt_title_new}'
                                            
                                products_description = soup.find(id="feature-bullets").text.replace('About this item ', '').strip()
                                ...
                                if product_urls in existing_product_urls:
                                    ...
                                    print(">>>>> product_urls added to the file. <<<<<")
                                    ...
                                    out = cv2.VideoWriter('output_video.mp4', fourcc, 30, (width, new_height))
                                    ...
                                    os.remove("Product_Video.mp4")
                                    os.remove("my_audio.mp3")
                                    os.remove("my_video_no_audio.mp4")
                                    os.remove("my_final_video.mp4")
                                    os.remove("output_video.mp4")
                                    os.remove("Product_Video_frame_watermark.mp4")
                                    ...
                                    for file in files:
                                        print("file inside")
                                        if file.endswith('.mp4'):
                                            print("file include .mp4")
                                            channel = Channel()
                                            print("channel get")
                                            channel.login("client_secrets.json", "credentials.storage")
                                            print("channel login authenticate")
                                            mainvedio = file
                                            print(mainvedio)                                                           
                                            title= yt_title_new
                                            descr= yt_description
                                            ...
                                            # liking video
                                            video.like()
                                print("vedio uploaded sucessfully")
